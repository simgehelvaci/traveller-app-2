...
export default function SearchBar() {
  ...
  return (
    <><h1 className="text-3xl font-bold text-center ">
      ...
      <span className="text-gray-800">your next adventure with </span> 
      <span className="text-blue-500">traveller.</span> 
    </h1><div className="flex min-h-screen flex-col items-center bg-white pt-20 px-4">
        {/* Kategori butonları */}
        <div className="mb-6 flex flex-wrap justify-center gap-2">
          {categories.map((cat) => (
            <button
              ...
              className={`px-4 py-2 text-sm rounded-full border ${activeCategory === cat
